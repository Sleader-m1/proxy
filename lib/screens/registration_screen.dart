...
import 'package:first/screens/verification_screen.dart';
...
class _RegistrationScreenState extends State<RegistrationScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final signUpButton = Material(
      ...
      child: MaterialButton(
          ...
          onPressed: () {
            signUp(emailEditingController.text, passwordEditingController.text, firstNameEditingController.text);
          },
          child: Text(
            "SignUp",
  ...
  void signUp(String email, String password, String username) async {
    if (_formKey.currentState!.validate()) {
      var url = 'http://95.164.17.135:8000/api/reg';
